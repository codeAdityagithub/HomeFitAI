...
export enum ExerciseStartPosition {
    ...
    hanging_knee_raise = ExercisePosition.Bottom,
    hanging_straight_leg_raise = ExercisePosition.Bottom,
    seated_knee_tucks = ExercisePosition.Bottom,
    ...
    dumbbell_front_squat = ExercisePosition.Top,
    ...
    band_shoulder_press = ExercisePosition.Bottom,
    band_single_leg_split_squat = ExercisePosition.Top,
    band_squat = ExercisePosition.Top,
    band_stiff_leg_deadlift = ExercisePosition.Top,
