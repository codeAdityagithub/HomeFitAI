...
import type { PositionFunctionUnilateral } from "@/utils/tensorflow/functions.client";
    ...
    const animate = useCallback(
        async (currentTime: number) => {
            ...
            if (pose.score && pose.score > 0.4) {
                ...
                const top_right =
                    pos_right.current[pos_right.current.length - 1];
                    ...
                    if (
                        ...
                        if (reps_right_ref.current >= 50)
                            ...
                            if (type === "TUT" && time_left.current < duration)
                                setSuggestion(
                                    "Try going slower and controlling the movement."
                                );
                            else setSuggestion("");
            ...
            if (
                type === "Timed" &&
                duration - Math.round(totalTime.current) == 5
            ) {
